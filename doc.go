...
// tplwalker is a tool to copy and transform a directory of templates and other
// files to a target directory.  It will re-create subdirectories, regular
// files and symlinks from a source directory.  Files that end with a
